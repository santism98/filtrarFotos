const fotos = [
    {
      foto: '../media/viajes-1.jpg',
      info: 'foto 1',
      palabras: ['fiesta', 'ciudad']
    },
    {
      foto: '../media/viajes-2.jpg',
      info: 'foto 2',
      palabras: ['ciudad', 'salidas']
    },
    {
      foto: '../media/viajes-3.jpg',
      info: 'foto 3',
      palabras: ['fiesta', 'viajes', 'avion']
    },
    {
      foto: '../media/viajes-4.jpg',
      info: 'foto 4',
      palabras: ['parejas', 'salidas']
    },
    {
      foto: '../media/viajes-5.jpg',
      info: 'foto 5',
      palabras: ['familia', 'fiesta']
    },
    {
      foto: '../media/viajes-6.jpg',
      info: 'foto 6',
      palabras: ['parejas', 'ciudad', 'salidas']
    },
    {
      foto: '../media/viajes-7.jpg',
      info: 'foto 7',
